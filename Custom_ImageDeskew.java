...
public class Custom_ImageDeskew {
    ...
    private double cAlphaStart = -90;
    private double cAlphaStep = 0.2;
    private int cSteps = 180 * 5;
     ...
     * @param image
     */
    public Custom_ImageDeskew(BufferedImage image) {
        this.cImage = image;
    }
    ...
    public double getSkewAngle() {
        Custom_ImageDeskew.HoughLine[] hl;
        double sum = 0.0;
        int count = 0;
    ...
    private Custom_ImageDeskew.HoughLine[] getTop(int count) {

        Custom_ImageDeskew.HoughLine[] hl = new Custom_ImageDeskew.HoughLine[count];
        for (int i = 0; i < count; i++) {
            hl[i] = new Custom_ImageDeskew.HoughLine();
        }

        Custom_ImageDeskew.HoughLine tmp;
